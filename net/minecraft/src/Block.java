...
//            Material, AliasGlobal, IBlockAccess, AxisAlignedBB, 
//            EntityPlayer, World, ItemStack, EntityItem, 
//            Vec3D, MovingObjectPosition, StatList, StatCollector, 
//            StepSound, StepSoundStone, StepSoundSand, BlockStone, 
//            BlockGrass, BlockDirt, BlockSapling, BlockFlowing, 
//            BlockStationary, BlockSand, BlockGravel, BlockOre, 
//            BlockLog, BlockLeaves, BlockSponge, BlockGlass, 
//            BlockDispenser, BlockSandStone, BlockNote, BlockBed, 
//            BlockRail, BlockDetectorRail, BlockPistonBase, BlockWeb, 
//            BlockTallGrass, BlockDeadBush, BlockPistonExtension, BlockCloth, 
//            BlockPistonMoving, BlockFlower, BlockMushroom, BlockOreStorage, 
...
public class Block
{
    ...
    {
        if(LegendGlobal.fullBright || LegendGlobal.fullBright1)
        {
            return 1.3F;
        } else
        {
    ...
    {
        if(LegendGlobal.xRay)
        {
            int ai[] = LegendGlobal.blackList1;
            int i1 = ai.length;
            ...
            if(LegendGlobal.blackList1.length != 0)
            {
                return true;
            }
        } else
        if(LegendGlobal.cavefinder)
        {
            int ai1[] = LegendGlobal.blackList;
            int j1 = ai1.length;
        ...
        {
            int ai2[];
            int k1 = (ai2 = LegendGlobal.blackList).length;
