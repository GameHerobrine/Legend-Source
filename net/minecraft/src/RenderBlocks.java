...
//            EntityRenderer, Material, BlockFluid, MathHelper, 
//            World, BlockDoor
...
public class RenderBlocks
{
    ...
    private boolean renderBlockBed(Block block, int i, int j, int k)
    {
        ...
        j1 = ModelBed.field_22280_a[i1];
        if(flag)
        {
            j1 = ModelBed.field_22280_a[ModelBed.field_22279_b[i1]];
        }
        k1 = 4;
        switch(i1)
        {
        ...
        if(j1 != 2 && (renderAllFaces || block.shouldSideBeRendered(blockAccess, i, j, k - 1, 2)))
        {
        ...
        if(j1 != 3 && (renderAllFaces || block.shouldSideBeRendered(blockAccess, i, j, k + 1, 3)))
        {
        ...
        if(j1 != 4 && (renderAllFaces || block.shouldSideBeRendered(blockAccess, i - 1, j, k, 4)))
        {
        ...
        if(j1 != 5 && (renderAllFaces || block.shouldSideBeRendered(blockAccess, i + 1, j, k, 5)))
        {
    ...
    public boolean renderBlockRedstoneWire(Block block, int i, int j, int k)
    {
        ...
        if(byte0 == 0)
        {
            ...
            tessellator.addVertexWithUV(f6, (float)j + 0.015625F, f8, d1, d3);
            tessellator.addVertexWithUV(f6, (float)j + 0.015625F, f7, d1, d2);
            tessellator.addVertexWithUV(f5, (float)j + 0.015625F, f7, d, d2);
            tessellator.addVertexWithUV(f5, (float)j + 0.015625F, f8, d, d3);
            tessellator.setColorOpaque_F(f, f, f);
            tessellator.addVertexWithUV(f6, (float)j + 0.015625F, f8, d1, d3 + 0.0625D);
            tessellator.addVertexWithUV(f6, (float)j + 0.015625F, f7, d1, d2 + 0.0625D);
            tessellator.addVertexWithUV(f5, (float)j + 0.015625F, f7, d, d2 + 0.0625D);
            tessellator.addVertexWithUV(f5, (float)j + 0.015625F, f8, d, d3 + 0.0625D);
        } else
        if(byte0 == 1)
        {
            tessellator.addVertexWithUV(f6, (float)j + 0.015625F, f8, d1, d3);
        ...
        {
            tessellator.addVertexWithUV(f6, (float)j + 0.015625F, f8, d1, d3);
            tessellator.addVertexWithUV(f6, (float)j + 0.015625F, f7, d, d3);
            tessellator.addVertexWithUV(f5, (float)j + 0.015625F, f7, d, d2);
            tessellator.addVertexWithUV(f5, (float)j + 0.015625F, f8, d1, d2);
            tessellator.setColorOpaque_F(f, f, f);
            tessellator.addVertexWithUV(f6, (float)j + 0.015625F, f8, d1, d3 + 0.0625D);
            tessellator.addVertexWithUV(f6, (float)j + 0.015625F, f7, d, d3 + 0.0625D);
            tessellator.addVertexWithUV(f5, (float)j + 0.015625F, f7, d, d2 + 0.0625D);
            tessellator.addVertexWithUV(f5, (float)j + 0.015625F, f8, d1, d2 + 0.0625D);
        }
        if(!blockAccess.isBlockNormalCube(i, j + 1, k))
        {
