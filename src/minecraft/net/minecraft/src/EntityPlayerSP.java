...
import net.minecraft.src.me.Shxe.LegendEntityCamera;
import net.minecraft.src.me.Shxe.LegendGlobal;

// Referenced classes of package net.minecraft.src:
//            EntityPlayer, MouseFilter, Session, World, 
//            AliasEntityCamera, MovementInput, AchievementList, StatFileWriter, 
//            GuiAchievement, SoundManager, AxisAlignedBB, AliasGlobal, 
//            NBTTagCompound, GuiEditSign, GuiChest, GuiCrafting, 
//            GuiFurnace, GuiDispenser, EntityPickupFX, EffectRenderer, 
//            InventoryPlayer, GuiIngame, StatBase, Achievement, 
//            MathHelper, TileEntitySign, IInventory, TileEntityFurnace, 
...
public class EntityPlayerSP extends EntityPlayer
{
    ...
    public void moveEntity(double d, double d1, double d2)
    {
        ...
        {
            ((LegendEntityCamera)mc.renderViewEntity).setCamera(d, d1, d2, rotationYaw, rotationPitch);
            return;
        } else
        {
    ...
    public void onLivingUpdate()
    {
        ...
        pushOutOfBlocks(posX + (double)width * 0.34999999999999998D, boundingBox.minY + 0.5D, posZ - (double)width * 0.34999999999999998D);
        pushOutOfBlocks(posX + (double)width * 0.34999999999999998D, boundingBox.minY + 0.5D, posZ + (double)width * 0.34999999999999998D);
        LegendGlobal.runFly(this);
        LegendGlobal.freecamNew(this);
