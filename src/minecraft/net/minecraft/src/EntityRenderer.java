...
//            Entity, Material, EntityPlayer, AliasGlobal, 
//            Block, RenderGlobal, EntityPlayerSP, MouseHelper, 
//            ScaledResolution, GuiIngame, GuiScreen, GuiParticle, 
//            ChunkProviderLoadOrGenerate, EffectRenderer, IChunkProvider, ClippingHelperImpl, 
//            Frustrum, RenderEngine, RenderHelper, InventoryPlayer, 
//            WorldChunkManager, BiomeGenBase, EntitySmokeFX, EntityRainFX, 
//            Tessellator, WorldProvider
...
public class EntityRenderer
{
    ...
    {
        EntityLiving entityliving = mc.renderViewEntity;
        float f1 = LegendGlobal.freecamNew1 ? entityliving.yOffset : entityliving.yOffset - 1.62F;
