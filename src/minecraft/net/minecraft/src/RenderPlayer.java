...
//            ItemStack, ItemArmor, Item, ModelRenderer, 
//            EntityPlayerSP, RenderManager, FontRenderer, Tessellator, 
...
public class RenderPlayer extends RenderLiving
{
    ...
    protected boolean setArmorModel(EntityPlayer entityplayer, int i, float f)
    {
        ...
        if(itemstack != null)
        {
            ...
            if(item instanceof ItemArmor)
            {
                ...
                loadTexture((new StringBuilder()).append("/armor/").append(armorFilenamePrefix[itemarmor.renderIndex]).append("_").append(i == 2 ? 2 : 1).append(".png").toString());
                ModelBiped modelbiped = i == 2 ? modelArmor : modelArmorChestplate;
    ...
    {
    	if(LegendGlobal.PlayerESP) {
    		RenderGlobal.drawPlayerESP(d, d1, d2);
    	}
        if(Minecraft.isGuiEnabled() && entityplayer != renderManager.livingPlayer)
        {
            ...
            float f3 = entityplayer.isSneaking() ? 63F : 64F;
            if(f2 < f3)
            {
                ...
                } else
                {
                    ...
                    fontrenderer.drawString(s, -fontrenderer.getStringWidth(s) / 2, i, 0xff0000);
