...
//            Render, AliasGlobal, ModelBase, EntityLiving, 
//            MathHelper, RenderManager, FontRenderer, Tessellator, 
//            GuiIngame, Entity
...
public class RenderLiving extends Render
{
            ...
            float f, float f1)
    {
        ...
        {
            GL11.glTexEnvi(8960 /*GL_TEXTURE_ENV*/, 8704 /*GL_TEXTURE_ENV_MODE*/, 7681 /*GL_REPLACE*/);
        }
        ...
        if(LegendGlobal.fullBright || LegendGlobal.fullBright1)
        {
            GL11.glTexEnvi(8960 /*GL_TEXTURE_ENV*/, 8704 /*GL_TEXTURE_ENV_MODE*/, 8448 /*GL_MODULATE*/);
        }
    ...
    protected void renderLivingLabel(EntityLiving entityliving, String s, double d, double d1, double d2, int i)
    {
        ...
        tessellator.draw();
        GL11.glEnable(3553 /*GL_TEXTURE_2D*/);
        if(GuiIngame.NameList.contains(s))
        {
            fontrenderer.drawString(s, -fontrenderer.getStringWidth(s) / 2, byte0, 65280);
