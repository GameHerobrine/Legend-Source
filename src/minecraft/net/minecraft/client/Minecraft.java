    ...
    private void clickMouse(int i)
    {
        ...
        if(objectMouseOver.typeOfHit == EnumMovingObjectType.TILE)
        {
            ...
            } else
            {
                ...
                int j1 = itemstack1 != null ? itemstack1.stackSize : 0;
                ...
                if(Keyboard.getEventKeyState())
                {
                    ...
                    } else
                    {
                        ...
                        } else
                        {
                        	...
                        	LegendMain.keyPress(Keyboard.getEventKey());
